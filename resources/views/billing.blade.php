              ...
              @forelse ($datauser as $data)
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-xs">Nama User: <span class="text-dark font-weight-bold ms-sm-2">{{ $data->name }}</span></span>
                    <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">{{ $data->email }}</span></span>
                    <span class="text-xs">Tanggal Aktif: <span class="text-dark ms-sm-2 font-weight-bold">{{ $data->created_at }}</span></span>
                  </div>
